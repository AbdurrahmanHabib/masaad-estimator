...
- β Don't use instructive language like*no* or*don't*. (e.g., "No walls").
- β Do describe what you don't want to see. (e.g., "wall, frame").
...
|------------------------|-----------------------------------------|----------------------------------------------------------------------------|--------------------------------------------------------------|----------------------------------------------------------------------|
| **Audio**              | Natively generates audio with video.    | Natively generates audio with video.                                       | βοΈ Always on                                                 | β Silent only                                                        |
