...
| `D_FLAT_MAJOR_B_FLAT_MINOR` | Dβ­ major / Bβ­ minor         |
| `D_MAJOR_B_MINOR`           | D major / B minor           |
| `E_FLAT_MAJOR_C_MINOR`      | Eβ­ major / C minor          |
| `E_MAJOR_D_FLAT_MINOR`      | E major / Cβ―/Dβ­ minor       |
| `F_MAJOR_D_MINOR`           | F major / D minor           |
| `G_FLAT_MAJOR_E_FLAT_MINOR` | Gβ­ major / Eβ­ minor         |
| `G_MAJOR_E_MINOR`           | G major / E minor           |
| `A_FLAT_MAJOR_F_MINOR`      | Aβ­ major / F minor          |
| `A_MAJOR_G_FLAT_MINOR`      | A major / Fβ―/Gβ­ minor       |
| `B_FLAT_MAJOR_G_MINOR`      | Bβ­ major / G minor          |
| `B_MAJOR_A_FLAT_MINOR`      | B major / Gβ―/Aβ­ minor       |
